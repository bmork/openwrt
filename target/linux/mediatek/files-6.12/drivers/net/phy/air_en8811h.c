...
static inline int phy_get_rx_polarity(struct fwnode_handle *fwnode, const char *mode_name,
				      unsigned int supported, unsigned int default_val)
{
	return PHY_POL_NORMAL;
}

static inline int phy_get_tx_polarity(struct fwnode_handle *fwnode, const char *mode_name,
				      unsigned int supported, unsigned int default_val)
{
	return PHY_POL_NORMAL;
}
...
static int an8811hb_config_serdes_polarity(struct phy_device *phydev)
{
	...
	pol = air_buckpbus_reg_modify(phydev, AN8811HB_RX_POLARITY,
