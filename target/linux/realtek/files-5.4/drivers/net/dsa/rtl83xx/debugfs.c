...
void rtl838x_serdes_init(struct dentry *dir, struct rtl838x_switch_priv *priv)
{
	...
	debugfs_create_u32("RTL8380_SDS5_INTF_CTRL", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0x24));
	debugfs_create_u32("RTL8380_SDS5_REG0", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF180));
	debugfs_create_u32("RTL8380_SDS5_REG1", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF184));
	debugfs_create_u32("RTL8380_SDS5_REG2", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF188));
	debugfs_create_u32("RTL8380_SDS5_REG3", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF18C));
	debugfs_create_u32("RTL8380_SDS5_REG4", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF190));
	debugfs_create_u32("RTL8380_SDS5_REG5", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF194));
	debugfs_create_u32("RTL8380_SDS5_REG6", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF198));
	debugfs_create_u32("RTL8380_SDS5_REG7", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF19C));
	debugfs_create_u32("RTL8380_SDS5_REG8", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1A0));
	debugfs_create_u32("RTL8380_SDS5_REG9", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1A4));
	debugfs_create_u32("RTL8380_SDS5_REG10", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1A8));
	debugfs_create_u32("RTL8380_SDS5_REG11", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1AC));
	debugfs_create_u32("RTL8380_SDS5_REG12", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1B0));
	debugfs_create_u32("RTL8380_SDS5_REG13", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1B4));
	debugfs_create_u32("RTL8380_SDS5_REG14", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1B8));
	debugfs_create_u32("RTL8380_SDS5_REG15", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1BC));
	debugfs_create_u32("RTL8380_SDS5_REG16", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1C0));
	debugfs_create_u32("RTL8380_SDS5_REG17", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1C4));
	debugfs_create_u32("RTL8380_SDS5_REG18", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1C8));
	debugfs_create_u32("RTL8380_SDS5_REG19", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1CC));
	debugfs_create_u32("RTL8380_SDS5_REG20", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1D0));
	debugfs_create_u32("RTL8380_SDS5_REG21", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1D4));
	debugfs_create_u32("RTL8380_SDS5_REG22", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1D8));
	debugfs_create_u32("RTL8380_SDS5_REG23", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1DC));
	debugfs_create_u32("RTL8380_SDS5_REG24", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1E0));
	debugfs_create_u32("RTL8380_SDS5_REG25", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1E4));
	debugfs_create_u32("RTL8380_SDS5_REG26", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1E8));
	debugfs_create_u32("RTL8380_SDS5_REG27", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1EC));
	debugfs_create_u32("RTL8380_SDS5_REG28", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1F0));
	debugfs_create_u32("RTL8380_SDS5_REG29", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1F4));
	debugfs_create_u32("RTL8380_SDS5_REG30", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF1F8));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG0", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF300));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG1", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF304));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG2", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF308));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG3", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF30C));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG4", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF310));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG5", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF314));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG6", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF318));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG7", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF31C));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG8", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF320));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG9", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF324));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG10", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF328));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG11", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF32C));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG12", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF330));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG13", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF334));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG14", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF338));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG15", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF33C));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG16", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF340));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG17", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF344));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG18", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF348));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG19", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF34C));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG20", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF350));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG21", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF354));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG22", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF358));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG23", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF35C));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG24", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF360));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG25", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF364));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG26", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF368));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG27", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF36C));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG28", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF370));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG29", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF374));
	debugfs_create_u32("RTL8380_SDS5_FIB_EXT_REG30", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF378));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG0", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF880));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG1", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF884));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG2", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF888));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG3", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF88C));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG4", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF890));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG5", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF894));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG6", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF898));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG7", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF89C));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG8", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8A0));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG9", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8A4));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG10", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8A8));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG11", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8AC));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG12", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8B0));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG13", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8B4));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG14", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8B8));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG15", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8BC));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG16", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8C0));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG17", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8C4));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG18", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8C8));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG19", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8CC));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG20", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8D0));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG21", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8D4));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG22", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8D8));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG23", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8DC));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG24", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8E0));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG25", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8E4));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG26", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8E8));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG27", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8EC));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG28", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8F0));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG29", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8F4));
	debugfs_create_u32("RTL8380_SDS5_EXT_REG30", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF8F8));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG0", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF900));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG1", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF904));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG2", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF908));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG3", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF90C));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG4", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF910));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG5", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF914));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG6", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF918));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG7", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF91C));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG8", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF920));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG9", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF924));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG10", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF928));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG11", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF92C));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG12", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF930));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG13", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF934));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG14", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF938));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG15", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF93C));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG16", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF940));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG17", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF944));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG18", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF948));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG19", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF94C));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG20", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF950));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG21", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF954));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG22", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF958));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG23", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF95C));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG24", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF960));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG25", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF964));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG26", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF968));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG27", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF96C));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG28", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF970));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG29", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF974));
	debugfs_create_u32("RTL8380_SDS5_FIB_REG30", 0644, dir, (u32 *)(RTL838X_SW_BASE + 0xF978));
